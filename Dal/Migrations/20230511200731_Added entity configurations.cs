...
{
    public partial class Addedentityconfigurations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertReactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertReactions_UserId",
                table: "AdvertReactions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Adverts_Heading",
                table: "Adverts",
                column: "Heading");

            migrationBuilder.CreateIndex(
                name: "IX_Adverts_IsDraft",
                table: "Adverts",
                column: "IsDraft");
